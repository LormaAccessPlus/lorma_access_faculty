...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // School Database Connection (Read-only for most operations)
        'school_db' => [
            'driver' => 'mysql',
            ...
            'charset' => env('SCHOOL_DB_CHARSET', 'utf8mb4'),
            'collation' => env('SCHOOL_DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                PDO::MYSQL_ATTR_SSL_CA => env('SCHOOL_DB_MYSQL_ATTR_SSL_CA'),
            ]) : [],
        ],
