...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('formula.config', ['subject' => $subject, 'term' => $term]) }}" 
                   ...
                   onmouseout="this.style.backgroundColor='#E67E22';">
                    <i class="fas fa-calculator mr-2"></i>Configure Formulas
                </a>
                <a href="{{ route('grade-matrix.customized.matrix', $subject) }}" class="text-white px-4 py-2 rounded-lg font-medium transition-colors"
                ...
                <a href="{{ route('grade-matrix.customized') }}" class="px-4 py-2 rounded-lg font-medium transition-colors border"
                   ...
                   onmouseout="this.style.backgroundColor='white'; this.style.color='#08695A';">
                    <i class="fas fa-arrow-left mr-2"></i>Back to Customized Matrix
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border mb-6" x-data="{ 
        ...
        <div class="border-b border-gray-200">
            <nav class="flex space-x-8 px-6" aria-label="Tabs">
                @foreach(['prelim', 'midterm', 'finals'] as $termKey)
                    <a href="{{ route('grade-matrix.customized.term', ['subject' => $subject, 'term' => $termKey]) }}"
        ...
        <div class="p-6 border-b border-gray-200 bg-gray-50 hidden" x-data="{ 
            ...
            termConfig: {
                // Customized Matrix: Read from database or use default 60/40
                class_standing_weight: {{ $gradingConfig->class_standing_weight ?? 60 }},
                exam_weight: {{ $gradingConfig->exam_weight ?? 40 }}
            },
            finalConfig: {
