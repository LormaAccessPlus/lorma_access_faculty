...
@section('title', 'Zero-based Matrix')

@section('page-title', 'Zero-based Matrix')
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Zero-based Matrix</h2>
                <p class="mt-1 text-sm text-gray-600">Manage grades for your subjects using zero-based calculation</p>
            </div>
            ...
            @foreach($subjects as $subject)
                <div class="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <!-- Actions -->
                        <div class="space-y-2">
                            <a href="{{ route('grade-matrix.zero-based.matrix', $subject) }}" 
