...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('grade-matrix.zero-based.matrix', $subject) }}" class="text-white px-4 py-2 rounded-lg font-medium transition-colors"
                ...
                <a href="{{ route('grade-matrix.zero-based') }}" class="px-4 py-2 rounded-lg font-medium transition-colors border"
                   ...
                   onmouseout="this.style.backgroundColor='white'; this.style.color='#08695A';">
                    <i class="fas fa-arrow-left mr-2"></i>Back to Zero-based Matrix
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border mb-6" x-data="{ 
        ...
        <div class="border-b border-gray-200">
            <nav class="flex space-x-8 px-6" aria-label="Tabs">
                @foreach(['prelim', 'midterm', 'finals'] as $termKey)
                    <a href="{{ route('grade-matrix.zero-based.term', ['subject' => $subject, 'term' => $termKey]) }}"
        ...
        <div class="p-6 border-b border-gray-200 bg-gray-50 hidden" x-data="{ 
            ...
            termConfig: {
                // Zero-Based Matrix always uses these defaults
                class_standing_weight: 40,
                exam_weight: 60
            },
            finalConfig: {
            ...
            <div class="flex items-center justify-between mb-4">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Default: 40% CS + 60% Exam (editable)</p>
                </div>
