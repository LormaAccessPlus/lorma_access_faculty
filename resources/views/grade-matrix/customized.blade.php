...
@section('title', 'Customized Matrix')

@section('page-title', 'Customized Matrix')
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-2xl font-bold text-gray-900">Customized Matrix</h2>
                <p class="mt-1 text-sm text-gray-600">Create and configure your own custom grading matrix</p>
            </div>
            ...
            @foreach($subjects as $subject)
                <div class="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <!-- Actions -->
                        <div class="space-y-2">
                            <a href="{{ route('grade-matrix.customized.matrix', $subject) }}" 
                            ...
                            <a href="{{ route('grade-matrix.customized.term', $subject) }}" 
